    ...
    <>
      ...
      <div className={`side-bar ${isOpen ? 'open' : 'closed'}`}>
        ...
        <div className="menu-content">
            ...
            <button onClick={() => handleNavigation('admin/add/city')}>Додати місто</button>
            <button onClick={() => handleNavigation('admin/add/theater')}>Додати театр</button>
            <button onClick={() => handleNavigation('admin')}>Дашборд</button>
        </div>
        }
      </div>
    </>
